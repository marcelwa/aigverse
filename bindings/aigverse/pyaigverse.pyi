...
class FanoutAig(Aig):
    ...
    def fanout(self, n: AigNode | int) -> list[AigNode]: ...
    def substitute_node(self, n: AigNode | int, f: AigSignal) -> None: ...
    def substitute_node_no_restrash(self, n: AigNode, f: AigSignal) -> None: ...
