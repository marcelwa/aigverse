...
def test_pickle_complex_aig() -> None:
    ...
    # c = aig.create_pi()
    #
    # f1 = aig.create_maj(a, b, c)
    # f2 = aig.create_xor(a, b)
    # f3 = aig.create_or(f1, f2)
    #
    # aig.create_po(f1)
    # aig.create_po(f2)
    # aig.create_po(f3)
    ...
    # Check the size and gate count of the unpickled AIG
    # assert unpickled_aig.size() == 22
    # assert unpickled_aig.num_gates() == 16
