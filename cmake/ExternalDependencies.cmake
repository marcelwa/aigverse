...
if(NOT pybind11_FOUND)
  if(AIGVERSE_VENDOR_PYBIND11)
    message(STATUS "pybind11 not found; fetching v${AIGVERSE_PYBIND11_VERSION} via FetchContent")
    ...
    message(FATAL_ERROR "pybind11 (>=${AIGVERSE_PYBIND11_VERSION}) not found and AIGVERSE_VENDOR_PYBIND11=OFF. Set pybind11_DIR or enable vendorization.")
  endif()
endif()
