...
1. Get the code
   ...
   If you do not have write access to the [marcelwa/aigverse](https://github.com/marcelwa/aigverse) repository,
   ...
   If you do have write access to the [marcelwa/aigverse](https://github.com/marcelwa/aigverse) repository,
...
4. We highly recommend using [`uv`](https://docs.astral.sh/uv/). It is an extremely fast Python package and project manager, written in Rust and developed by [Astral](https://astral.sh/) (the same team behind [`ruff`](https://docs.astral.sh/ruff/)).
...
The project uses _CMake_ as the main build configuration tool.
