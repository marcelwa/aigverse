...
class Aig:
    ...
    def __setstate__(self, state: tuple[list[int]]) -> None: ...
...
class AigEdge:
    ...
    @overload
    def __init__(self, source: int | AigNode, target: int | AigNode, weight: int = 0) -> None: ...
    @overload
    def __init__(self) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __ne__(self, other: object) -> bool: ...
...
class AigEdgeList:
    ...
    @overload
    def __init__(self, ntk: Aig, edges: list[AigEdge]) -> None: ...
