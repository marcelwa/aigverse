...
def read_aiger_into_aig(filename: str | PathLike[str]) -> NamedAig: ...
def read_ascii_aiger_into_aig(filename: str | PathLike[str]) -> NamedAig: ...
def read_aiger_into_sequential_aig(filename: str | PathLike[str]) -> SequentialAig: ...
def read_ascii_aiger_into_sequential_aig(filename: str | PathLike[str]) -> SequentialAig: ...
def read_pla_into_aig(filename: str | PathLike[str]) -> Aig: ...
def read_verilog_into_aig(filename: str | PathLike[str]) -> NamedAig: ...
def write_aiger(ntk: Aig, filename: str | PathLike[str]) -> None: ...
def write_verilog(ntk: Aig, filename: str | PathLike[str]) -> None: ...
