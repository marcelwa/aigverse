...
def read_aiger_into_aig(filename: str | PathLike[str]) -> Aig: ...
def read_ascii_aiger_into_aig(filename: str | PathLike[str]) -> Aig: ...
...
def read_verilog_into_aig(filename: str | PathLike[str]) -> Aig: ...
